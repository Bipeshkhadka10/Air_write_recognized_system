  ...
  return (
    <div className="login-container">
        ...
        <div id="logo-content flex flex-col justify-center items-center">
          ...
          <div id="logo-discp flex">
            ...
            <p className="text-sm text-gray-500">
              Start writing in the air today.
            </p>
          </div>
        </div>
        ...
        <form action={formAction} method="post">
          <div className="form-content">
            <div className="name-field">
              ...
              {data?.error?.name && (
                <p className="form-error">{data?.error?.name}</p>
              )}
              <br />
            </div>
            ...
            <div className="password-field">
              ...
              {data?.error?.confirmPassword && (
                <p className="form-error"> {data?.error?.confirmPassword}</p>
              )}
            </div>
          </div>
          ...
          <div className="btn-other">
            <button
              type="button"
              onClick={() =>
                (window.location.href = "http://localhost:5000/auth/google","_self")
              }
      ...
      >
        ...
        <path
          d="M 0,500 L 0,187 C 100.53571428571428,213.53571428571428 201.07142857142856,240.07142857142858 319,210 C 436.92857142857144,179.92857142857142 572.25,93.24999999999999 709,110 C 845.75,126.75000000000001 983.9285714285713,246.92857142857144 1106,277 C 1228.0714285714287,307.07142857142856 1334.0357142857142,247.03571428571428 1440,187 L 1440,500 L 0,500 Z"
          stroke="none"
          stroke-width="0"
          fill="url(#gradient)"
          fill-opacity="1"
